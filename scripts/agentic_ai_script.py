           ...
           # get rule from dqm
            ...
            for each_activity in dqm_activity:
                ...
                if description.get('field') != 'Threshold' and description.get('field') != 'Loaded Rows':
                    ...
                    if dqm_history.get(activity_datetime) is not None:
                        x = dqm_history[activity_datetime]
                        x.append({field: value})
                    else:
                        dqm_history[activity_datetime] = [{field: value}]
            ...
            fixes_response = dq_agent.generate_fix(schema_name,table_name,column_name,query,rule_statement,dq_score,passing_flag,dqm_history)
